...
public class HighScoreUtility2 {
	...
	public static class HighScoreRecord implements Comparable<HighScoreRecord> {
		...
		private static String[] defaultRecord() {
			return new String[] { "Miss A 500", "Miss B 400", "Miss C 300", "Miss D 200", "Miss E 100" };
		}
	...
	private static String readFileName = "highscore2";
	...
	public static void recordHighScore(int score) {
		...
		if (index >= highScoreRecord.length) {
			...
			try {
				...
				BufferedWriter out = new BufferedWriter(new FileWriter("highscore2"));
				String writeRecord = "";
				for (int i = 0; i < highScoreRecord.length; i++) {
